...
export const experience: {
  ...
  },
  {
    ...
    bullets: [
      "Five years building and maintaining production web applications end to end, across client engagements including Opensoft Dominicana and Unclick Technologies.",
...
// "Kalenday es un producto de Opensoft DO LLC", so the earlier claim of
